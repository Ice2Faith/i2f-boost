package i2f.extension.ftp.sftp;

import com.jcraft.jsch.*;
import i2f.core.file.FileUtil;
import i2f.extension.ftp.sftp.data.ISftpMetaMeta;
...
public class SftpUtil implements Closeable{
    private ISftpMetaMeta meta;
    private Session session;
    private ChannelSftp channelSftp;
    public SftpUtil(ISftpMetaMeta meta){
        setMeta(meta);
    }
    public SftpUtil setMeta(ISftpMetaMeta meta){
        this.meta=meta;
        return this;
    }
