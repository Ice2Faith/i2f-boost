package i2f.extension.netty;

import i2f.extension.netty.extension.impl.HttpRequestDispatchAdapter;
...
//                pipeline.addLast(httpHandler);
    ...
    public static void startNettyHttpServer(int port,String ... basePackages) throws InterruptedException, IOException {
