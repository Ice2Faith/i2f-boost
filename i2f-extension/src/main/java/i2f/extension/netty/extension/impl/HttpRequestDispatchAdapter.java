package i2f.extension.netty.extension.impl;
...
import i2f.extension.netty.annotation.*;
import i2f.extension.netty.extension.AbstractHttpRequestHandler;
import i2f.extension.netty.extension.HttpWebRequest;
import i2f.extension.netty.extension.HttpWebResponse;
...
public class HttpRequestDispatchAdapter extends AbstractHttpRequestHandler {
    ...
    public static void addMapping(String path,Class clazz,String methodName){
        Method method= ReflectResolver.matchMethod(clazz,methodName, HttpWebRequest.class, HttpWebResponse.class);
    ...
    public static void addMappingByScanPackage(String ... basePackages) throws IOException {
    ...
    public static void addMappingByScanClass(Class clazz){
        Set<Method> methods=ReflectResolver.getMethodsWithAnnotations(clazz,false, NettyRequestMapping.class);
