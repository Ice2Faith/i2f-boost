...
public class EsQryUtil {
    ...
    public static class SearchBuilder{
        ...
        public ApiPage<Map<String,Object>> respPage(){
            ...
            SearchHit[] list=hits.getHits();
            List<Map<String,Object>> data=new ArrayList<>(list.length);
            for(SearchHit item : list){
                data.add(item.getSourceAsMap());
            }
            ret.setList(data);
            return ret;
        }
