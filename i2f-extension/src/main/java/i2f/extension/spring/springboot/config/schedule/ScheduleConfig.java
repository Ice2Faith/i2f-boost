package i2f.extension.spring.springboot.config.schedule;
 ...
 * @desc
 */
@ConditionalOnExpression("${i2f.springboot.config.schedule.enable:true}")
@Slf4j
@Data
@NoArgsConstructor
@EnableScheduling
@Configuration
@ConfigurationProperties(prefix = "i2f.springboot.config.schedule")
