...
echo 1.expand [task schduled program]
...
echo 15.browser shell file [batch.sh]
echo 16.set start from is [the batch.sh file location directory]
echo 17.comfirm operation
