...
echo 0 0 1 * * cd /home;sh batch.sh
echo 3.explain for this line
echo [0 0 1 * *] is cron expression
echo [cd /home;sh batch.sh] is execute command line
echo [cd /home;] right run batch.sh need before change directory to batch.sh location
