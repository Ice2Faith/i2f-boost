...
import i2f.springboot.secure.util.ReflectUtils;
...
public class SecureTransferAop implements InitializingBean {
    ...
    public Object controllerLog(ProceedingJoinPoint pjp) throws Throwable{
        ...
        SecureHeader requestHeader = (SecureHeader)request.getAttribute(SecureConsts.SECURE_HEADER_ATTR_KEY);
        ...
        if(requestHeader!=null){
            ...
            for(int i=0;i< params.length;i++){
                ...
                SecureParams pann= ReflectUtils.getAnnotation(parameter,SecureParams.class);
                if(pann==null){
                    continue;
                }
                if(!pann.in()){
