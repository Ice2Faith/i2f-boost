...
window.$date = {
    ...
    formatDate:function (date, patten) {
        ...
        let ret = patten;
        ret = $str.replaceAll(ret, 'yyyy', $str.paddingString(year, 4, '0'));
        ret = $str.replaceAll(ret, 'MM', $str.paddingString(month, 2, '0'));
        ret = $str.replaceAll(ret, 'dd', $str.paddingString(day, 2, '0'));
        ret = $str.replaceAll(ret, 'HH', $str.paddingString(hour, 2, '0'));
        ret = $str.replaceAll(ret, 'mm', $str.paddingString(min, 2, '0'));
        ret = $str.replaceAll(ret, 'ss', $str.paddingString(sec, 2, '0'));
        ret = $str.replaceAll(ret, 'SSS', $str.paddingString(msec, 3, '0'));
        ret = $str.replaceAll(ret, 'hh', $str.paddingString(hour12, 2, '0'));

        ret = $str.replaceAll(ret, 'y', $str.paddingString(year, 0));
        ret = $str.replaceAll(ret, 'M', $str.paddingString(month, 0));
        ret = $str.replaceAll(ret, 'd', $str.paddingString(day, 0));
        ret = $str.replaceAll(ret, 'H', $str.paddingString(hour, 0));
        ret = $str.replaceAll(ret, 'm', $str.paddingString(min, 0));
        ret = $str.replaceAll(ret, 's', $str.paddingString(sec, 0));
        ret = $str.replaceAll(ret, 'S', $str.paddingString(msec, 0));
        ret = $str.replaceAll(ret, 'h', $str.paddingString(hour12, 0));
