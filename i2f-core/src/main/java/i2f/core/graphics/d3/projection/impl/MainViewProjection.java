 ...
 * @desc 主视图,yoz,转换到xoy(投影到xoy平面)
 */
@Data
@NoArgsConstructor
public class MainViewProjection extends AbstractMatrixProjection {
    public MainViewProjection(boolean enableMatrix) {
        super(enableMatrix);
    }
    ...
    public Point proj(D3Point point) {
        return new Point(point.z,point.y);
    }
