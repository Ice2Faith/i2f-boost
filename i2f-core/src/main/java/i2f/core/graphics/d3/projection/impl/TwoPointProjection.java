...
@Data
@NoArgsConstructor
public class TwoPointProjection extends AbstractMatrixProjection implements IViewPointProjection {
    protected double r;
    protected double d;
    ...
    public TwoPointProjection(boolean enableMatrix, D3SphericalPoint viewPoint, double d) {
        super(enableMatrix);
