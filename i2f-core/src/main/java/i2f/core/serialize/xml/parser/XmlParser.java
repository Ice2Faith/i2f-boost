package i2f.core.serialize.xml.parser;
...
public class XmlParser {
     ...
     * _ab2="ccc-+/*+..*\""
     */
    public static final String REG_KEY_EQUAL_VALUE= RegexGenerator.DECLARE_NAME_REGEX+"\\s*=\\s*"+RegexGenerator.QUOTE_STRING_REGEX;
