package i2f.core.generate.core;
...
public class ObjectFinder {
     ...
     * @return
     */
    @Usage("Object val=getObjectByDotKeyWithReference(obj,\"elem.args[2].age@java.lang.Integer.parseInt\")")
    ...
    public static Object getObjectByDotKeyWithReference(Object obj, String dotKey,List<String> baseRefPackages){
        ...
        Object val= ValueResolver.get(obj,simpleDotKey);
    ...
    public static Object referenceDotKeyConvert(Object obj,String dotKey,List<String> basePackages){
        ...
        if(refClassName!=null && !"".equals(refClassName)){
            refClass= ReflectResolver.getClazz(refClassName);
        }
        if(basePackages!=null){
            for(String item : basePackages){
                ...
                refClass=ReflectResolver.getClazz(langRefCLass);
            }
        }
        if(refClass==null){
            if(obj!=null) {
    ...
    public static Field getClassFieldByName(Class clazz,String fieldName){
        ...
        CollectionUtil.mergeCollection(sets,declare,fields);
        for(Field item : sets){
    ...
    public static Object getConvertObjectByMethodName(Object obj, Class refClass, String refMethodName) {
        Set<Method> methods= ReflectResolver.findMethodsByName(refClass, refMethodName);
        if(methods.size()==0){
            return obj;
        }
        ...
        for(Method item : methods){
            ...
            if(pcount==1){
                ...
                if(ConvertResolver.isValueConvertible(obj,typeClass)){
        ...
        if(matchMethod.size()>0){
            ...
            if(Modifier.isStatic(method.getModifiers())){
                ...
                if(objClass.equals(refClass)){
                    ...
                    ivkObj=ReflectResolver.instance(refClass);
                }
            }
        }else{
            isMatch=false;
        ...
        try{
            if(method.getParameterCount()>0){
                ...
                if(isMatch){
                    ...
                    cvtObj=ConvertResolver.isValueConvertible(obj, typeClass);
                }
                if(isVoidRet){
    ...
    public static Object getConvertObjectByConstructor(Object obj, Class refClass) {
        Set<Constructor> constructors= ReflectResolver.getAllConstructors(refClass);
