...
import i2f.core.reflection.reflect.exception.FieldNotFoundException;
import i2f.core.reflection.reflect.exception.MethodNotFoundException;
import i2f.core.reflection.reflect.impl.*;
...
public class ValueVisitor {
    ...
    public static ValueAccessor visit(Object obj, String routePatten){
        ...
        if("null".equals(patten)){
            return new NullValueAccessor();
        }
        if("true".equals(patten)){
            return new ReadonlyValueAccessor(true);
        }
        if("false".equals(patten)){
            return new ReadonlyValueAccessor(false);
        }
        if("class".equals(patten)){
            return new ReadonlyValueAccessor(obj.getClass());
        }
