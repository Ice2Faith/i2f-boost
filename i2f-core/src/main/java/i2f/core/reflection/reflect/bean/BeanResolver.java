...
public class BeanResolver {
    ...
    public static<T> T copy(Object srcObj, T dstObj) {
        return copy(srcObj, dstObj, false);
    }

    public static<T> T copy(Object srcObj, T dstObj, boolean includeNull) {
        return copy(srcObj, dstObj, includeNull, null);
    }
     ...
     * @return
     */
    public static<T> T copy(Object srcObj, T dstObj, boolean includeNull, ICompare<String> keyCmp) {
    ...
    public static Map<String,Object> bean2Map(Object obj,boolean includeNull){
    ...
    public static<T> T empty2null(T obj,boolean trim){
        if(obj==null){
            return obj;
        }
