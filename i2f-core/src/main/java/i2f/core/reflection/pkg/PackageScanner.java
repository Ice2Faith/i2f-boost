...
import i2f.core.reflection.pkg.core.PackageBaseScanner;
import i2f.core.reflection.pkg.data.ClassMetaData;
import i2f.core.reflection.pkg.data.ClassMetaTree;
import i2f.core.reflection.pkg.filter.IClassFilter;
...
public class PackageScanner {
    ...
    public static void initWorkEnv(boolean useDefault,String ... basePackages) throws IOException {
    ...
    public static List<ClassMetaData> scanClasses(IClassFilter filter, Class entryClazz) throws IOException {
    ...
    public static List<ClassMetaData> scanClasses(IClassFilter filter, String ... basePacks) throws IOException {
