 ...
 * @desc
 */
public enum BcDesEdeType implements IEncryptType {
    /**
     * 默认
     */
    ...
    private BcDesEdeType(String type, boolean noPadding, boolean requireVector) {
        this.type = type;
    ...
    public static final int[] SECRET_BYTES_LEN = {112, 168}; // 112 or 168
