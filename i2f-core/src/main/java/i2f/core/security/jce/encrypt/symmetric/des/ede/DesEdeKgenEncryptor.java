package i2f.core.security.jce.encrypt.symmetric.des.ede;
...
public class DesEdeKgenEncryptor extends BasicKgenSymmetricEncryptor {
    ...
    public DesEdeKgenEncryptor() {
        super(DesEdeType.ECB_PKCS5PADDING);
    }

    public DesEdeKgenEncryptor(DesEdeType type) {
        super(type);
    }
