 ...
 * @desc
 */
public class OtcStringByteCodec implements IStringByteCodec {
    public static OtcStringByteCodec INSTANCE = new OtcStringByteCodec(null);
    private String separator;

    public OtcStringByteCodec() {
    }

    public OtcStringByteCodec(String separator) {
