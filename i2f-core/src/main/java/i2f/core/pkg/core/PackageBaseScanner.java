...
public class PackageBaseScanner {
    ...
    public static List<ClassMetaData> scanClassNamesBaseClasses(Class ... classes) throws IOException {
    ...
    public static List<ClassMetaData> scanClassNamesBasePackages(String ... basePackages) throws IOException {
        ...
        for(String pkg : items){
            ...
            try{
                URL[] urlEnum= ResourceUtil.getClasspathResources(item);
                for(URL url :  urlEnum){
                    urls.put(url,pkg);
                }
            }catch(Exception e){
    ...
    public static List<ClassMetaData> scanAllClassNames() throws IOException {
        List<ClassMetaData> list = new ArrayList<>(CLASS_NAMES_COUNT);
    ...
    public static Class loadClassByName(String className) {
        ...
        try {
             ...
             * succss:9669
             */
            clazz=ResourceUtil.getLoader().loadClass(className);
        } catch (Throwable e) {
