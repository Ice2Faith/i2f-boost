...
import i2f.core.io.file.core.FileSpecies;
...
public class FileUtil {
    ...
    public static List<String> readTxtFile(File file, int offsetLine, @CloudBe("-1") int lineCount, boolean ignoreBlankLine, boolean trimLine) throws IOException {
