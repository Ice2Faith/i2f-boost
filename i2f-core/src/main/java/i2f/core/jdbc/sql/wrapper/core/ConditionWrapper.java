...
public class ConditionWrapper<N>
    ...
    public <T, R> ConditionWrapper<N> cond(boolean cond, IBeanGetter<T, R> getter, String ope, Object val) {
        String name = DbFinder.dbFieldName(getter);
        return cond(cond, name, ope, val);
    }

    public <T, V1> ConditionWrapper<N> cond(boolean cond, IBeanSetter<T, V1> setter, String ope, Object val) {
        String name = DbFinder.dbFieldName(setter);
        return cond(cond, name, ope, val);
    }

    public <R, T, V1> ConditionWrapper<N> cond(boolean cond, IBeanBuilder<R, T, V1> builder, String ope, Object val) {
    ...
    //////////////////////////////////////////////////////////////
    public <T, R> ConditionWrapper<N> eq(boolean cond, IBeanGetter<T, R> getter, Object val) {
        return cond(cond, getter, Sql.EQ, val);
    }

    public <T, R> ConditionWrapper<N> neq(boolean cond, IBeanGetter<T, R> getter, Object val) {
        return cond(cond, getter, Sql.NEQ, val);
    }

    public <T, R> ConditionWrapper<N> gt(boolean cond, IBeanGetter<T, R> getter, Object val) {
        return cond(cond, getter, Sql.GT, val);
    }

    public <T, R> ConditionWrapper<N> lt(boolean cond, IBeanGetter<T, R> getter, Object val) {
        return cond(cond, getter, Sql.LT, val);
    }

    public <T, R> ConditionWrapper<N> gte(boolean cond, IBeanGetter<T, R> getter, Object val) {
        return cond(cond, getter, Sql.GTE, val);
    }

    public <T, R> ConditionWrapper<N> lte(boolean cond, IBeanGetter<T, R> getter, Object val) {
        return cond(cond, getter, Sql.LTE, val);
    }

    public <T, R> ConditionWrapper<N> in(boolean cond, IBeanGetter<T, R> getter, Iterator<?> val) {
        return cond(cond, getter, Sql.IN, val);
    }

    public <T, R> ConditionWrapper<N> like(boolean cond, IBeanGetter<T, R> getter, Object val) {
        return cond(cond, getter, Sql.LIKE, val);
    }

    public <T, R> ConditionWrapper<N> likes(boolean cond, IBeanGetter<T, R> getter, Iterator<?> val) {
        String name = DbFinder.dbFieldName(getter);
        return likes(cond, name, val);
    }

    public ConditionWrapper<N> multiLikeGetter(boolean cond, Iterator<IBeanGetter> getters, Object val) {
        List<String> cols = new ArrayList<>();
        while (getters.hasNext()) {
            IBeanGetter item = getters.next();
    ...
    /////////////////////////////////////////////////
    public <T, R> ConditionWrapper<N> eq(boolean cond, IBeanSetter<T, R> setter, Object val) {
        return cond(cond, setter, Sql.EQ, val);
    }

    public <T, R> ConditionWrapper<N> neq(boolean cond, IBeanSetter<T, R> setter, Object val) {
        return cond(cond, setter, Sql.NEQ, val);
    }

    public <T, R> ConditionWrapper<N> gt(boolean cond, IBeanSetter<T, R> setter, Object val) {
        return cond(cond, setter, Sql.GT, val);
    }

    public <T, R> ConditionWrapper<N> lt(boolean cond, IBeanSetter<T, R> setter, Object val) {
        return cond(cond, setter, Sql.LT, val);
    }

    public <T, R> ConditionWrapper<N> gte(boolean cond, IBeanSetter<T, R> setter, Object val) {
        return cond(cond, setter, Sql.GTE, val);
    }

    public <T, R> ConditionWrapper<N> lte(boolean cond, IBeanSetter<T, R> setter, Object val) {
        return cond(cond, setter, Sql.LTE, val);
    }

    public <T, R> ConditionWrapper<N> in(boolean cond, IBeanSetter<T, R> setter, Iterator<?> val) {
        return cond(cond, setter, Sql.IN, val);
    }

    public <T, R> ConditionWrapper<N> like(boolean cond, IBeanSetter<T, R> setter, Object val) {
        return cond(cond, setter, Sql.LIKE, val);
    }

    public <T, R> ConditionWrapper<N> likes(boolean cond, IBeanSetter<T, R> setter, Iterator<?> val) {
        String name = DbFinder.dbFieldName(setter);
        return likes(cond, name, val);
    }

    public ConditionWrapper<N> multiLikeSetter(boolean cond, Iterator<IBeanSetter> setters, Object val) {
        List<String> cols = new ArrayList<>();
        while (setters.hasNext()) {
            IBeanSetter item = setters.next();
            String name = DbFinder.dbFieldName(item);
            cols.add(name);
        }
        return multiLike(cond, cols.iterator(), val);
    ...
    public <T, R> ConditionWrapper<N> cond(IBeanGetter<T, R> getter, String ope, Object val) {
        String name = DbFinder.dbFieldName(getter);
        return cond(true, name, ope, val);
    }

    public <T, V1> ConditionWrapper<N> cond(IBeanSetter<T, V1> setter, String ope, Object val) {
        String name = DbFinder.dbFieldName(setter);
        return cond(true, name, ope, val);
    }

    public <R, T, V1> ConditionWrapper<N> cond(IBeanBuilder<R, T, V1> builder, String ope, Object val) {
        String name = DbFinder.dbFieldName(builder);
        return cond(true, name, ope, val);
    }
    ...
    //////////////////////////////////////////////////////////////
    public <T, R> ConditionWrapper<N> eq(IBeanGetter<T, R> getter, Object val) {
        return cond(true, getter, Sql.EQ, val);
    }

    public <T, R> ConditionWrapper<N> neq(IBeanGetter<T, R> getter, Object val) {
        return cond(true, getter, Sql.NEQ, val);
    }

    public <T, R> ConditionWrapper<N> gt(IBeanGetter<T, R> getter, Object val) {
        return cond(true, getter, Sql.GT, val);
    }

    public <T, R> ConditionWrapper<N> lt(IBeanGetter<T, R> getter, Object val) {
        return cond(true, getter, Sql.LT, val);
    }

    public <T, R> ConditionWrapper<N> gte(IBeanGetter<T, R> getter, Object val) {
        return cond(true, getter, Sql.GTE, val);
    }

    public <T, R> ConditionWrapper<N> lte(IBeanGetter<T, R> getter, Object val) {
        return cond(true, getter, Sql.LTE, val);
    }

    public <T, R> ConditionWrapper<N> in(IBeanGetter<T, R> getter, Iterator<?> val) {
        return cond(true, getter, Sql.IN, val);
    }

    public <T, R> ConditionWrapper<N> like(IBeanGetter<T, R> getter, Object val) {
        return cond(true, getter, Sql.LIKE, val);
    }

    public <T, R> ConditionWrapper<N> likes(IBeanGetter<T, R> getter, Iterator<?> val) {
        String name = DbFinder.dbFieldName(getter);
        return likes(true, name, val);
    }

    public ConditionWrapper<N> multiLikeGetter(Iterator<IBeanGetter> getters, Object val) {
        return multiLikeGetter(true, getters, val);
    }

    /////////////////////////////////////////////////
    public <T, R> ConditionWrapper<N> eq(IBeanSetter<T, R> setter, Object val) {
        return cond(true, setter, Sql.EQ, val);
    }

    public <T, R> ConditionWrapper<N> neq(IBeanSetter<T, R> setter, Object val) {
        return cond(true, setter, Sql.NEQ, val);
    }

    public <T, R> ConditionWrapper<N> gt(IBeanSetter<T, R> setter, Object val) {
        return cond(true, setter, Sql.GT, val);
    }

    public <T, R> ConditionWrapper<N> lt(IBeanSetter<T, R> setter, Object val) {
        return cond(true, setter, Sql.LT, val);
    }

    public <T, R> ConditionWrapper<N> gte(IBeanSetter<T, R> setter, Object val) {
        return cond(true, setter, Sql.GTE, val);
    }

    public <T, R> ConditionWrapper<N> lte(IBeanSetter<T, R> setter, Object val) {
        return cond(true, setter, Sql.LTE, val);
    }

    public <T, R> ConditionWrapper<N> in(IBeanSetter<T, R> setter, Iterator<?> val) {
        return cond(true, setter, Sql.IN, val);
    }

    public <T, R> ConditionWrapper<N> like(IBeanSetter<T, R> setter, Object val) {
        return cond(true, setter, Sql.LIKE, val);
    }

    public <T, R> ConditionWrapper<N> likes(IBeanSetter<T, R> setter, Iterator<?> val) {
        String name = DbFinder.dbFieldName(setter);
        return likes(true, name, val);
    }

    public ConditionWrapper<N> multiLikeSetter(Iterator<IBeanSetter> setters, Object val) {
