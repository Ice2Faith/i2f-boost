...
public class DbFinder {
    ...
    public static<T,R> String dbFieldName(IGetter<T,R> getter)  {
        return dbFileNameProxy(getter);
    }
    public static<T,V1> String dbFieldName(ISetter<T,V1> getter)  {
        return dbFileNameProxy(getter);
    }
    public static<T,R,V1> String dbFieldName(IBuilder<T,R,V1> getter)  {
        return dbFileNameProxy(getter);
    }
    public static String dbFileNameProxy(Serializable lmb){
        ...
        String fieldName=Lambdas.fieldGetter(methodName);
